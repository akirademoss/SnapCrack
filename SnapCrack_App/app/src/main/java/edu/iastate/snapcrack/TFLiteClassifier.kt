...
class TFLiteClassifier(private val context: Context) {
    ...
    private fun initializeInterpreter() {
        ...
        labels = loadLines(context, "model_labels.txt")
        val options = Interpreter.Options()
        gpuDelegate = GpuDelegate() //TODO issue with delegates?
    ...
    private fun getMaxResult(result: FloatArray): Int {
        ...
        //TODO evaluate based on threshold that makes sense for model
        if(probability > 0.0000005) {
            Log.d(TAG, "Probability bigger than 0.0000005 with $probability")
        }
        var index = 0
...
//    }
    ...
    private fun classify(bitmap: Bitmap): String {
        ...
        Log.d(TAG, "Input tensors: " + interpreter?.inputTensorCount + "   Output tensors: " + interpreter?.outputTensorCount)
