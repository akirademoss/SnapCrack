package edu.iastate.snapcrack.util;/* Copyright 2019 The TensorFlow Authors. All Rights Reserved.
...
import edu.iastate.snapcrack.Classifier;
...
public class MultiBoxTracker {
    ...
    private void processResults(final List<Classifier.Recognition> results) {
        ...
        for (final Classifier.Recognition result : results) {
            ...
            Log.v(TAG, "Result! Frame: " + result.getLocation() + " mapped to screen:" + detectionScreenRect);
